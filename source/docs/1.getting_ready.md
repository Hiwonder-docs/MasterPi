...
<img  class="common_img" src="../_static/media/1.getting_ready/1.1/image0.png" alt="loading" />
...
<table class="docutils-nobg" border="1">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>1</td>
      <td><img src="../_static/media/1.getting_ready/1.1/image4.png"  alt="loading" width="30%" ></td>
    </tr>
    <tr>
      <td>5</td>
      <td>Raspberry Pi 5 expansion board</td>
      <td>1</td>
      <td><img  class="common_img" src="../_static/media/1.getting_ready/1.1/image5.png"  alt="loading" width="30%" ></td>
    </tr>
    <tr>
      <td>6</td>
    ...
    <tr>
      ...
      <td>1</td>
      <td><img  class="common_img" src="../_static/media/1.getting_ready/1.1/image7.png"  alt="loading" width="30%"></td>
    </tr>
    <tr>
      <td>8</td>
      <td>32G TF card</td>
      <td>1</td>
      <td><img  class="common_img" src="../_static/media/1.getting_ready/1.1/image8.png"  alt="loading" width="30%"></td>
    </tr>
    <tr>
      <td>9</td>
      <td>TT motor</td>
