...
The source code of this program is saved in：[/home/pi/MasterPi/functions/color_warning.py](https://store.hiwonder.com.cn/docs/masterpi/source_code/ai-vision-projects/color_warning.zip)
...
(10) Follow steps 1–2 of "[**Change Default Recognized Color**](#anchor_5_1_5)" to open the program file and press the "**i**" key to enter INSERT mode.
...
(20) Refer to "[**5.1.2 Start and Close the Game**](#anchor_1_2)" to restart the gameplay. Place a purple object in front of the camera. The purple object should be outlined in the returned image, and "**purple**" should be printed. If you want to revert to the default recognized color, follow the steps in "[Change Default Recognized Color](#anchor_5_1_5)" to set the color to purple.
...
<img src="../_static/media/9.ai_vision_project_course/1.2/1.gif" class="common_img" />
...
The program corresponding to this lesson is stored in **[/home/pi/MasterPi/functions/color_detect.py](https://store.hiwonder.com.cn/docs/masterpi/source_code/ai-vision-projects/color_detect.zip)**
...
(1) Double-click <img src="../_static/media/9.ai_vision_project_course/1.2/image6.png"  style="width:45px"  /> on system desktop and then click "**Execute**" in the pops-up window.
...
(10) According to the steps in "[**Adjust Color Threshold**](#anchor_5_2_5)", Modify "**red**" in "**detect_color == 'red'**" to "**purple**" as the figure shown below: 
...
The program corresponding to this lesson is stored in [/home/pi/MasterPi/functions/color_sorting.py](https://store.hiwonder.com.cn/docs/masterpi/source_code/ai-vision-projects/color_sorting.zip)
...
The source code of this program is saved in: [/home/pi/MasterPi/functions/color_recognition.py](https://store.hiwonder.com.cn/docs/masterpi/source_code/ai-vision-projects/color_recognition.zip)
...
(1) Double-click the system desktop icon <img src="../_static/media/9.ai_vision_project_course/1.4/image26.png" style="width:45px"  />and click "**Execute**" in the pop-up window.
...
The program corresponding to this lesson is stored in：[/home/pi/MasterPi/functions/color_tracking.py](https://store.hiwonder.com.cn/docs/masterpi/source_code/ai-vision-projects/color_tracking.zip)
...
(1)  Double-click <img src="../_static/media/9.ai_vision_project_course/1.5/image9.png" style="width:45px" /> on system desktop, and then click "**Execute**" in the pop-up window.
...
(5) Find the corresponding code and modify "**red**" in "_**target_color = ('red')**" to "**blue**" as shown in the figure below:
...
(1) Double-click <img src="../_static/media/9.ai_vision_project_course/1.5/image31.jpeg"  style="width:45px" /> on system desktop and then click "**Execute**" in the pops-up window.
...
<img src="../_static/media/9.ai_vision_project_course/1.5/image30.png" class="common_img" />
...
The program corresponding to this lesson is stored in: [/home/pi/MasterPi/functions/visual_patrol.py](https://store.hiwonder.com.cn/docs/masterpi/source_code/ai-vision-projects/visual_patrol.zip)
...
You need to first import the function library during the initialization.Regarding the content imported, please refer to "[**5.6.4 Import Parameter Module**](#ancro_6_5_1)".
...
The source code of the program is saved in: ：[/home/pi/MasterPi/functions/face_recgonition.py](https://store.hiwonder.com.cn/docs/masterpi/source_code/ai-vision-projects/face_recognition.zip)
...
The program corresponding to this lesson is stored in [/home/pi/MasterPi/functions/avoidance.py](https://store.hiwonder.com.cn/docs/masterpi/source_code/ai-vision-projects/avoidance.zip).
