...
:::{Note}
玩法开始前请确保已参照"[学前先看\5.偏差调试](https://docs.hiwonder.com/projects/MasterPi/en/latest/docs/1.getting_ready.html#id17)"课程对机械臂偏差进行调节。**
:::
...
1. 将机器人开机，然后通过VNC远程连接树莓派桌面。关于VNC的安装及连接，可参考"**[学前先看\4.远程工具安装与连接](https://docs.hiwonder.com/projects/MasterPi/en/latest/docs/1.getting_ready.html#id17)**"。
...
1. 将设备开机，并参照课程资料的"**[学前先看\4远程工具安装与连接](https://docs.hiwonder.com/projects/MasterPi/en/latest/docs/1.getting_ready.html#id17)**"内容，通过VNC远程连接工具连接。
