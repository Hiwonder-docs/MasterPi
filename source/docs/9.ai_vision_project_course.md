...
(10) Follow steps 1–2 of "[1.4.1 Change Default Recognized Color](#anchor_1_4_1)" to open the program file and press the "i" key to enter INSERT mode.
...
(20) Refer to "[1.2 Start and Close the Game](#anchor_1_2)" to restart the gameplay. Place a purple object in front of the camera. The purple object should be outlined in the returned image, and "purple" should be printed. If you want to revert to the default recognized color, follow the steps in "[1.4.1 Change Default Recognized Color](#anchor_1_4_1)" to set the color to purple.
...
* If the color recognition is inaccurate, refer to the "2.4 Function Extension --> [2.4.1 Add Recognized Color](#anchor_2_5_3)" section of this document to set the color threshold.
:::
...
You need to first import the function library during the initialization.Regarding the content imported, please refer to "[2.4.1 Import Parameter Module"](#anchor_2_4_1).
...
(14) Start the game again according to "[2.2 Start and Close the Games](#anchor_2_2)" and then place the purple object in front of the camera. You can find that the robot will perform "nod" action.
...
You need to first import the function library during the initialization.Regarding the content imported, please refer to "[3.4.1 Import Parameter Module](#anchor_3_4_1)".
...
*  If color recognition is inaccurate, refer to the section "[4.4 Function Extension/ 4.4.1 Adjusting Color Threshold](#anchor_4_4_1)" in this document to adjust the color threshold settings.
  :::
...
You need to first import the function library during the initialization.Regarding the content imported, please refer to "[5.3.1 Import Parameter Module](#anchor_5_5_1)".
...
:::{Note}
The color to be modified must be in color option bar. If want to modify to other colors, you can refer to "[5.5.3 Add Recognized Color]($anchro_5_5_3)" to add a new recognition color.
:::
...
(10) According to the steps of "[5.4.2 Modify Tracking Color](#anchor_5_5_2)", open the program file ,and enter the editing mode, and then modify "red" in "_target_color = ('red')" to "purple" as the figure shown below: 
...
(12) Refer to "[5.2 Start and Close the Game](#anchor_5_2)" to start the game. Then MasterPi will track the purple object.
...
You need to first import the function library during the initialization.Regarding the content imported, please refer to "[8.5.1 Import Parameter Module](#anchor_8_5_1)".
...
(7) Refer to the operation steps in "[8.2 Operation Steps](#anchor_8_2)" to start game. MasterPi will turn left when the distance between MasterPi and object is less than or equal to 40cm.
...
(7) According to "[8.2 Operation Steps](#anchor_8_2)" to start the game again, MasterPi will move at the speed of 20.
