# 5. Robot Arm Inverse Kinematics Basic Course
...
### 1.2 Position and Translation Transformation
...
### 1.3 Angle Rotation Transformation
...
## 3. Single Control Multiple Servos
...
The source code of the program is stored in [/home/pi/MasterPi/board_demo/ control_by_servo.py]()
...
## 4. Control the Movement of Robotic Arm
...
The source code of program is stored in : [/home/pi/MasterPi/board_demo/control_by_kinematics.py]().
