# 4. Mecanum Wheel Car Motion Control Course

## 1. The Motion of Mecanum Wheels Car
...
### 1.3 **Kinematic Analysis Formula Calculation**
...
The source code of the program is located in:**[/home/pi/MasterPi/mecanum_control/car_forward_demo.py]()**
...
**2.4.2 Program Logic and Corresponding Code Analysis**

**(1) Import Function Library**

During initialization, the function library needs to be first imported for subsequent calling. For the detailed content of importing, please refer to “[2.5.1 Import Parameter Module]()”.
...
(7) After modifying, please refer to the content of “[2.2 Operation Steps]()” to check the outcome.
...
After starting the game, MasterPi will be clockwise stationary rotation, and then counterclockwise stationary rotation. 

### 3.4 Program Analysis

The source code of the program is located in: **[/home/pi/MasterPi/mecanum_control/car_turn_demo.py]()**
...
During initialization, the function library needs to be first imported for subsequent calling. For the detailed content of importing, please refer to “3.4.1 Import Parameter Module”.
...
(5) In `set_velocity` function, the first parameter represents the rotation speed of the car and we modify it to 0.5. After modifying, press “Esc” and enter “:wq”, and then press “Enter” to save ans exit.
...
The source code of program is located in: ：**[/home/pi/MasterPi/mecanum_control/car_move_demo.py]()**
...
**4.4.2 Program Logic and Corresponding Code Analysis**

**(1) Import Function Library**

During initialization, the function library needs to be first imported for subsequent calling. For the detailed content of importing, please refer to “5.1 Import Parameter Module”.
...
(6) After modifying, please refer to the content of “[4.2 Operation Steps]()” to check the outcome.
...
The source code of program is located in: **[/home/pi/MasterPi/mecanum_control/car_slant_demo.py]()**
...
**5.4.2 Program Logic and Corresponding Code Analysis**

**(1) Import Function Library**

During initialization, the function library needs to be first imported for subsequent calling. For the detailed content of importing, please refer to “5.5.1 Import Parameter Module”.
...
(6) After modifying, please refer to the content of “2.Operation Steps” to check the outcome.
...
The source code of program is located in：**[/home/pi/MasterPi/mecanum_control/car_drifting_demo.py]()**
...
**6.4.2 Program Logic and Corresponding Code Analysis**

**(1) Import Function Library**

During initialization, the function library needs to be first imported for subsequent calling. For the detailed content of importing, please refer to “6.5.1 Import Parameter Module”.
...
(5) In`set_velocity` function, the first parameter represents the rotation speed of the car and we modify it to 0.5. After modifying, press “Esc” and enter “:wq”, and then press “Enter” to save and exit.
...
(6) After modifying, please refer to the content of “[6.2 Operation Steps]()” to check the outcome.
