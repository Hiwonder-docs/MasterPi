...
The source code of the program is located in: **[/home/pi/MasterPi/mecanum_control/car_forward_demo.py](https://store.hiwonder.com.cn/docs/masterpi/source_code/mecanum-wheel-car-motion-control/car_forward_demo.zip)**
...
The source code of the program is located in: **[/home/pi/MasterPi/mecanum_control/car_turn_demo.py](https://store.hiwonder.com.cn/docs/masterpi/source_code/mecanum-wheel-car-motion-control/car_turn_demo.zip)**
...
<img src="../_static/media/6.motion_control_course/1.4/1.gif"  />

### 3.4.4 Program Analysis 

The source code of program is located in: ：**[/home/pi/MasterPi/mecanum_control/car_move_demo.py](https://store.hiwonder.com.cn/docs/masterpi/source_code/mecanum-wheel-car-motion-control/car_move_demo.zip)**
...
The source code of program is located in: **[/home/pi/MasterPi/mecanum_control/car_slant_demo.py](https://store.hiwonder.com.cn/docs/masterpi/source_code/mecanum-wheel-car-motion-control/car_slant_demo.zip)**
...
During initialization, the function library needs to be first imported for subsequent calling. For the detailed content of importing, please refer to **"3.5.4 Program Analysis \ Import Parameter Module"**.
...
<img src="../_static/media/6.motion_control_course/1.6/1.gif"  />

### 3.6.4 Program Analysis 

The source code of program is located in：**[/home/pi/MasterPi/mecanum_control/car_drifting_demo.py](https://store.hiwonder.com.cn/docs/masterpi/source_code/mecanum-wheel-car-motion-control/car_drifting_demo.zip)**
...
(6) After modifying, please refer to the content of "[3.6.2 Operation Steps](#anchor_6_2)" to check the outcome.
